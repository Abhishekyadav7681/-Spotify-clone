...
songs.forEach((song, i) => {
    ...
    // Assuming there is an <img> element within each songitem
    let imgElement = songitem[i].querySelector("img");
    if (imgElement) {
        imgElement.src = song.coverPath;
    }

    // Assuming there is a <span class="songname"> element within each songitem
    let songNameElement = songitem[i].querySelector(".songname");
    if (songNameElement) {
